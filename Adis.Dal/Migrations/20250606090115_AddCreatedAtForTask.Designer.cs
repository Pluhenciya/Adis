...
namespace Adis.Dal.Migrations
{
    ...
    [Migration("20250606090115_AddCreatedAtForTask")]
    partial class AddCreatedAtForTask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Adis.Dm.Project", b =>
                {
                    ...
                    b.Property<DateOnly?>("ActualEndExecutionDate")
                        .HasColumnType("date")
                    ...
                    b.Property<DateOnly?>("PlannedEndExecutionDate")
                        .HasColumnType("date")
                    ...
                    b.HasIndex("StartDate", "PlannedEndDate")
                        .HasDatabaseName("ix_projects_dates");

                    b.ToTable("projects", null, t =>
                        {
                            t.HasCheckConstraint("chk_projects_dates", "start_date <= planned_end_date");
                        });
                });
